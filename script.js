document.addEventListener('DOMContentLoaded', () => {
    ...
    const templates = {
        ...
        permanent: {
            'false-report': {
                subject: 'Urgent Security Review: Malicious False Reporting Campaign - {number}',
            ...
            'hacked-account': {
                subject: 'Critical Security Incident: Unauthorized Account Access & Subsequent Restriction - {number}',
            ...
            'unsolicited-communication': {
                subject: 'Policy Compliance Realignment: Communication Standards Appeal - {number}',
            ...
            'malicious-content': {
                subject: 'Content Distribution Review: Unintentional Policy Violation Appeal - {number}',
            ...
            'multiple-reports': {
                subject: 'Comprehensive Account Review: Multiple Report Analysis Request - {number}',
            ...
            'illegal-activities': {
                subject: 'Formal Legal Compliance Appeal: Erroneous Association with Prohibited Activities - {number}',
            ...
            'third-party-app-use': {
                subject: 'Compliance Acknowledgment: Third-Party Application Remediation Complete - {number}',
            ...
            'Circumventing-a-Previous-Ban': {
              subject: 'Formal Appeal: Account Restoration Request with Compliance Commitment - {number}',
          ...
          'Malicious-software-or-Phishing-Links':{
            subject: 'Security Education Appeal: Unwitting Distribution of Compromised Content - {number}',
